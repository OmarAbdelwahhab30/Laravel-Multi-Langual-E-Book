...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-dark text-light">{{ __('register.Register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('register.Username') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('register.Phone') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="img" class="form-label col-md-4 col-form-label text-md-right">{{__('register.Choose Profile Picture')}}</label>
                            <div class="col-md-6">
